    ...
    <div>
        ...
        <div className="sm:col-span-3 mt-6">
          ...
          <div className="mt-2 flex">
            <input
              ...
              className="text-sm leading-6 text-gray-900 font-normal block w-full rounded-md border-gray-300 shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm uppercase"
            />
            <button
              onClick={fetchStockData}
              className="ml-2 inline-flex justify-center items-center rounded-md bg-cyan-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
            >
              {isLoading ? (
      ...
      >
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  readOnly
                  className="text-sm leading-6 text-gray-900 font-normal block w-full rounded-md border-gray-300 shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm"
                />
              </div>
            </div>
            {/* Type */}
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  ...
                  onChange={handleChange}
                  className="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6"
                  required
                >
        ...
        <div className="mt-4 flex space-x-6 justify-end">
          <button
            type="button"
            className="mt-3 inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          ...
          <button
            type="submit"
            className=" inline-flex justify-center items-center rounded-md bg-cyan-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
          >
            {isLoading ? (
              <div className="flex w-full justify-center align-middle gap-2">
