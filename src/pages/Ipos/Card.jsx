...
export default function Cards({ ipos, isLoading, handleEdit, refreshIpos }) {
  ...
  const confirmDelete = async (iposId) => {
    setIsDeleting(true);
    try {
      const result = await deleteIpos(iposId);
          ...
          >
            ...
            <dl className="divide-y divide-gray-100 px-4 py-4 text-sm leading-6">
              ...
              <div className="flex justify-between gap-x-4 py-3">
                ...
                <dd className="flex items-start gap-x-2">
                  <div className="font-medium text-gray-900">
                    {ipos.preSharePrice === "To Be Announced"
                      ? ipos.preSharePrice
